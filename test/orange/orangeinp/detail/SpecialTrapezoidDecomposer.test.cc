...
//---------------------------------------------------------------------------//
#include "orange/orangeinp/detail/SpecialTrapezoidDecomposer.hh"
...
TEST_F(ConvexHullFinderTest, basic)
{
    ...
    SpecialTrapezoidDecomposer decompose(p, t);
}
////---------------------------------------------------------------------------//
///*
...
////---------------------------------------------------------------------------//
///*
// * Test case where the last point encountered is *not* part of the convex
// hull.
// *
...
//    expect_eq(VecVecReal2({{p[5], p[4], p[3]}}),
